...
export default function AbsensiPage() {
  ...
  // 2. Helper Perhitungan Rekap Riwayat
  ...
  return (
    <>
      {/* Script untuk memuat Tailwind CSS secara instan */}
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-4 gap-2 text-center">
                        <div className="bg-red-50 border border-red-100 p-2 rounded-xl">
                          <div className="text-[10px] font-bold text-red-500 uppercase">ALPHA</div>
                          <div className="text-lg font-extrabold text-red-600">{recap.alpha}</div>
                        </div>

                        <div className="bg-yellow-50 border border-yellow-100 p-2 rounded-xl">
                          <div className="text-[10px] font-bold text-yellow-600 uppercase">SAKIT</div>
                          <div className="text-lg font-extrabold text-yellow-600">{recap.sakit}</div>
                        </div>

                        <div className="bg-blue-50 border border-blue-100 p-2 rounded-xl">
                          <div className="text-[10px] font-bold text-blue-500 uppercase">IZIN</div>
                          <div className="text-lg font-extrabold text-blue-600">{recap.izin}</div>
                        </div>

                        <div className="bg-orange-50 border border-orange-100 p-2 rounded-xl">
                          <div className="text-[10px] font-bold text-orange-500 uppercase">TELAT</div>
                          <div className="text-lg font-extrabold text-orange-600">{recap.telat}</div>
                        </div>
                      </div>
                      ...
                      <div className="border border-gray-100 rounded-xl p-4 bg-gray-50/50 min-h-[100px] flex items-center justify-center text-center">
                        {recap.rawLogs.length === 0 ? (
                          ...
                          <div className="w-full text-left space-y-1 text-xs">
                            {recap.datesAlphaStr !== '-' && (
                              <p className="text-red-600"><strong>Alpha:</strong> {recap.datesAlphaStr}</p>
                            )}
                            {recap.datesSakitStr !== '-' && (
                              <p className="text-yellow-600"><strong>Sakit:</strong> {recap.datesSakitStr}</p>
                            )}
                            {recap.datesIzinStr !== '-' && (
                              <p className="text-blue-600"><strong>Izin:</strong> {recap.datesIzinStr}</p>
                            )}
                            {recap.datesTelatStr !== '-' && (
                              <p className="text-orange-600"><strong>Telat:</strong> {recap.datesTelatStr}</p>
                            )}
                          </div>
                        )}
                      </div>
